...
function setzeFarbe() {
    ...
    // Korrekt, dann weiterblättern
   if (radioA.checked) {
        // etwas Zeit verstreichen lassen
        window.setTimeout(function(){ verstecke(true); }, 1000);
        //window.setTimeout(verstecke(true), 3000); //Ruft die Callback-Funktion nach 3 Sekunden auf
        //verstecke(true);
    }
}
