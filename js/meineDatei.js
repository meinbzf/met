...
function nurGespeicherte() {
    let myData = localStorage.getItem(docTitle);
    alert("Gespeicherte Fragen: " + myData + "\n" + "Falls Daten nicht gespeichert, dann in Browser-Einstellungen Cookies und Website-Daten zulassen" + "\nVerwaltung: Pressing F12, then go to the Application tab (Web-Speicher). In the Storage section expand Local Storage");
    //let arrayGesplittet = myData.split(",");
